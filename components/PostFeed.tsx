...
const PostFeed = () => {
    ...
    return (
        <div className='mt-[80px] md:mt-5 md:ml-[300px] flex flex-col gap-6'>
            {
                fetched ? (!isFollowing ? (
                    <div className='md:w-[50%] w-full border px-5 py-5 place-content-center'>
                        You haven't Followed People Yet HeadOver to the <span className='text-blue-600'>people</span> Page and Follow Them
                    </div>
                ) : (
